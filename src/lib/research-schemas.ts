...
const REGULATION_SCHEMA = {
  ...
  properties: {
    ...
    creenciasDelJugador: { type: "array", items: { type: "string" } },
    miedos: {
      type: "array",
      items: {
        type: "object",
        properties: { miedo: { type: "string" }, deDondeSale: { type: "string" } },
        required: ["miedo", "deDondeSale"],
        additionalProperties: false,
      },
    },
    efectoEnLaConfianza: { type: "string" },
  },
  required: [
    "estado",
    "regulador",
