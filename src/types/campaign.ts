...
export const SHORT_AD_FORMAT_META: Record<KnownShortAdFormat, ShortAdFormatMeta> = {
  ...
  "comprobante-de-retiro": {
    id: "comprobante-de-retiro",
    name: "El retiro que sí llegó",
    role: "Ataca la objeción número uno, que no es ganar sino cobrar. La prueba la da el banco, no el casino.",
    origin: "propio",
    stages: ["MOFU", "BOFU"],
    hasText: true,
  },
  "donde-ya-pagas": {
    id: "donde-ya-pagas",
    name: "Con el banco que ya usas",
    role: "Quita la fricción del depósito enseñando los métodos locales de siempre. Nada nuevo que aprender.",
    origin: "propio",
    stages: ["MOFU", "BOFU"],
    hasText: true,
  },
  "cuanto-es-eso": {
    id: "cuanto-es-eso",
    name: "Cuánto es eso de verdad",
    role: "Traduce el premio a cosas de la vida: meses de arriendo, sueldos. Un número grande no se siente; una cuenta sí.",
    origin: "propio",
    stages: ["TOFU", "MOFU"],
    hasText: true,
  },
  "sueldo-de-por-vida": {
    id: "sueldo-de-por-vida",
    name: "El sueldo que no se acaba",
    role: "El premio recurrente contado como calendario, no como cifra. Vende tranquilidad y no euforia.",
    origin: "propio",
    stages: ["TOFU", "MOFU"],
    hasText: true,
  },
  "la-mesa-en-vivo": {
    id: "la-mesa-en-vivo",
    name: "La mesa en vivo te mira",
    role: "Una persona real mirando a cámara desde dentro de la pantalla. Rompe la idea de que es una máquina sola.",
    origin: "propio",
    stages: ["TOFU", "MOFU"],
    hasText: false,
  },
  "antes-de-dormir": {
    id: "antes-de-dormir",
    name: "La hora en la que se juega",
    role: "El momento real de uso: de noche, en el sillón, sin nadie mirando. Da permiso sin decirlo.",
    origin: "propio",
    stages: ["TOFU"],
    hasText: false,
  },
  "reaccion-de-los-otros": {
    id: "reaccion-de-los-otros",
    name: "La cara de los demás",
    role: "El ganador está de espaldas y quien se ve es la familia. La emoción se cuenta desde el reflejo.",
    origin: "propio",
    stages: ["TOFU", "MOFU"],
    hasText: true,
  },
  "sala-o-sillon": {
    id: "sala-o-sillon",
    name: "Ir hasta allá o no ir",
    role: "Dos columnas: el viaje al casino y el sillón de casa. El dispositivo es la comparación de esfuerzo.",
    origin: "propio",
    stages: ["MOFU"],
    hasText: true,
  },
